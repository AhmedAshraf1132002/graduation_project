...
export default function CableTricepsPullDown() {
  return (
    <>
    <Helmet>
      <title>
      ...
      <div className="cable-triceps-pull-down-section d-flex justify-content-center align-items-center">
        <div className="custom-card text-center p-4 shadow-lg rounded-4">
          <h2 className="text-white mb-4"> cable-triceps-pull-down</h2>
          <video
            width="100%"
            height="h-50"
            controls
